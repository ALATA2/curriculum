...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    ...
    ja: {
      ...
      hero_contact: "お問い合わせ",
      chi_sono_title: "自己紹介",
      chi_sono_text: "コモドールやアミガといったビデオゲームの歴史にルーツを持ち、現在はボルゴセージア（ヴァルセージア地方）を拠点に活動するデジタルクリエイター兼インディー開発者です。これまでのキャリアで、美術高校での芸術的な教育とトリノ大学での情報科学の技術的なスキルを融合させ、多才でハイブリッドなプロフィールを築いてきました。チームでのインディータイトルの制作から、エンターテインメント企業と連携したインタラクティブ体験の創造にいたるまで、私の目標は創造性、人工知能（AI）、そして確かなゲームデザインを融合し、オリジナリティがあり、スケール可能で、商業的に認知されるデジタルプロジェクトを実現することです。",
